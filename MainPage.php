...
<html>
	<head>
		...
		<div class = "menu">
			<?php if(strcmp($username,"Admin") == 0) 
			...
			<ul>
				<li class = "blogname"><a href = ><?php echo strtoupper($_SESSION['fullname']);?></a></li>
					...
					<li class = "tab3"><A target = "_blank" href = <?php if(isset($_SESSION['instagram']))echo $_SESSION['instagram'];else echo""?>>INSTAGRAM</A></li>&nbsp 
